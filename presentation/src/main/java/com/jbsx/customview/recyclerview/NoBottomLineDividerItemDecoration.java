...
/**
 * 没有底部分割线，和父类比只改了drawVertical的循环次数-1
 *
 * Created by lijian on 2018/12/9.
 */

public class NoBottomLineDividerItemDecoration extends DividerItemDecoration {
     ...
     */
    public NoBottomLineDividerItemDecoration(Context context, int orientation, boolean
            isShowBottomDivider) {
