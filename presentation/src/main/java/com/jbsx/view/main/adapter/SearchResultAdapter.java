...
public class SearchResultAdapter extends CommonListFragmentAdapter {
    ...
    public SearchResultAdapter(Context context, int imageWidth, OnFeedItemClick callback) {
        super(context);
    ...
    public CommonListFragmentViewHolder getViewHolder(View rootView, int viewType) {
        if (isAlbum(viewType)) {
            SearchResultAlbumHolder holder = new SearchResultAlbumHolder(getContext(), rootView);
            holder.setAdapter(this);
            return holder;
        } else {
            SearchResultVideoHolder holder = new SearchResultVideoHolder(getContext(), rootView);
            holder.setAdapter(this);
            return holder;
        }
    }
    ...
    public class SearchResultAlbumHolder extends CommonListFragmentViewHolder<SearchResultData.SearchResultItem> {
        ...
        public SearchResultAlbumHolder(Context context, View view) {
            super(view);
            mContext = context;
        }
    ...
    public class SearchResultVideoHolder extends CommonListFragmentViewHolder<SearchResultData.SearchResultItem> {
        private Context mContext;
        ...
        public SearchResultVideoHolder(Context context, View view) {
            super(view);
            mContext = context;
        }
