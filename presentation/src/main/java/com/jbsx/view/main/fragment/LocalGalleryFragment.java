...
public class LocalGalleryFragment extends BaseFragment {
    ...
    public static LocalGalleryFragment newInstance(String naviId, String naviType, Integer pageType,
        ...
        LocalGalleryFragment contentFragment = new LocalGalleryFragment();
    ...
    private void loadData() {
        ...
        mUserCase.requestLocalGalleryInfo(mRequestParams, new BaseRequestCallback() {
            @Override
...
//        mList.setAlphaItem(true); //设置半透渐变
        if (AppConstData.GALLERY_LOOP_SUPPORT) {
